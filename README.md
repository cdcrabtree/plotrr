[![Build Status](https://travis-ci.org/cdcrabtree/plotrr.svg?branch=master)](https://travis-ci.org/cdcrabtree/plotrr) [https://ci.appveyor.com/project/cdcrabtree/plotrr/master?svg=true](https://ci.appveyor.com/project/cdcrabtree/plotrr/master?svg=true)
